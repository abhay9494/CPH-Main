            ...
            <div class="help-container">
                ...
                <div class="option-group">
                    <div class="option-label">
                        <span>How to Use (Stealth Setup)</span>
                    </div>
                    <div class="usage-steps">
                        <div class="usage-step">
                            <strong>Add an Account:</strong> Go to Settings > Accounts. Add a Nickname (e.g. "Personal") and select an AI (ChatGPT/Gemini/Grok) to log in. No API keys are needed!
                        </div>
                        <div class="usage-step">
                            <strong>Select Your Mode:</strong> Toggle between <i>OA Speedrun Mode</i> (for coding tests) and <i>Live Interview Mode</i> (for live video calls) from the main interface.
                        </div>
                        <div class="usage-step">
                            <strong>Capture & Solve:</strong> Press ${this.formatKeybind(this.keybinds.nextStep)} to instantly screenshot your screen and trigger the AI to solve it.
                        </div>
                        <div class="usage-step">
                            <strong>The Panic Button:</strong> Press ${this.formatKeybind(this.keybinds.toggleVisibility)} at any time to instantly hide the Overlay, Mini-Widget, and AI background windows.
                        </div>
                        <div class="usage-step">
                            <strong>Click-Through Mode:</strong> Use ${this.formatKeybind(this.keybinds.toggleClickThrough)} to lock the overlay in place so you can click the code editor underneath it.
                        </div>
                    </div>
                </div>
                ...
                <div class="option-group">
                    <div class="option-label">
                        <span>Application Modes</span>
                    </div>
                    <div class="profiles-grid">
                        <div class="profile-item">
                            <div class="profile-name">🚀 OA Speedrun Mode</div>
                            <div class="profile-description">Optimized for coding assessments. Features a one-click Refactor button, code formatting, and dynamic language selection (C++, Python, Java, etc.).</div>
                        </div>
                        <div class="profile-item">
                            <div class="profile-name">👔 Live Interview Mode</div>
                            <div class="profile-description">Built for live video calls. Features teleprompter text zooming (A+/A-), behavioral formatting toggles (STAR, Bullets), and Profile Context injection.</div>
                        </div>
                        <div class="profile-item">
                            <div class="profile-name">👻 Ghost Browser Tech</div>
                            <div class="profile-description">Your AI instances run locally in hidden, isolated Chromium partitions. Completely invisible to screen sharing and standard proctoring.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="option-group">
                    ...
                    <div class="keyboard-section">
                        <div class="keyboard-group">
                            <div class="keyboard-group-title">Emergency & Stealth</div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Universal Hide (Panic)</span>
                        ...
                        <div class="keyboard-group">
                            ...
                            <div class="shortcut-item">
                                <span class="shortcut-description">Take screenshot & Solve</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.nextStep)}</div>
                            </div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Send text message</span>
                    ...
                    <div class="description" style="margin-top: 12px; text-align: center; opacity: 0.7;">
                        You can customize these shortcuts in the Settings menu.
                    </div>
                </div>
